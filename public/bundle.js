...
(function () {
	...
	*/
	...
	var AutoComplete = function (props) {
	    var _a = react_4(""), currVal = _a[0], setCurrVal = _a[1];
	    var _b = react_4([]), matched = _b[0], setMatched = _b[1];
	    react_5(function () {
	    ...
	    return (react.createElement("div", { className: "autocomplete" },
	        react.createElement("input", { type: "text", id: props.idProp, onKeyPress: function (e) {
	...
	function Journal(props) {
	    var _a = react_4([]), completed = _a[0], setCompleted = _a[1];
	...
	var Home = function () {
	    ...
	    return (react_3("div", { className: "home" },
	        react_3(Journal, { day: today, program: dailyProgram })));
	};
	reactDom_1(react_3(Home, null), document.getElementById("app"));
